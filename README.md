# CMN-C1-055 — Agent Task Specification & Decomposition Agent
...
Decomposes high-level task descriptions into structured subtask specifications with
acceptance criteria, effort indicators, and dependency hints. Targets project managers
and BAs working in SIer and project-based team environments. Default output is a
Markdown task decomposition plan; structured JSON output (GitLab issues, Jira, GitHub
issues) is also available via configuration.
